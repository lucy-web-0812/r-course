...
```{r}
dat_wide <- cll2 |> left_join(lon6, by='date', suffix=c("_cll2", "_lon6"))
mean(dat_wide$no_cll2, na.rm=T)
mean(dat_wide$no2_cll2, na.rm=T)
mean(dat_wide$o3_cll2, na.rm=T)
mean(dat_wide$no_lon6, na.rm=T)
mean(dat_wide$no2_lon6, na.rm=T)
mean(dat_wide$o3_lon6, na.rm=T)
sd(dat_wide$no_cll2, na.rm=T)
sd(dat_wide$no2_cll2, na.rm=T)
sd(dat_wide$o3_cll2, na.rm=T)
sd(dat_wide$no_lon6, na.rm=T)
sd(dat_wide$no2_lon6, na.rm=T)
sd(dat_wide$o3_lon6, na.rm=T)
```
