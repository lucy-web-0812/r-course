...
**"Tidy" your data using `pivot_longer()`, then find the mean and standard deviation of each pollutant, as well as the time at which each peaks maximum value of each.**

-  You'll not be able to do work out the mean/sd and the time at the same time - think about how you structure your script to avoid repeitition.
