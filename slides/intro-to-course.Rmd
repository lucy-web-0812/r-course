...
- Brief introduction to R, RStudio and Programming for beginners
...
- Introduction to R for Air Quality Data
  ...
  - What is a package and how do you use one?
...
- Fourth year PhD Student working with David Carslaw
- RStudio certified `tidyverse` instructor
- Work involves extracting insight from large data sets
